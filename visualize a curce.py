...
num_points = 50
angle_values = np.linspace(0, np.pi, num_points)  # Angles from 0 to pi
...
half_circle_curve = visual.ShapeStim(win, vertices=list(zip(x_values, y_values)), fillColor=None, lineColor='blue')
